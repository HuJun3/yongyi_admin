...
var _default = {
  methods: {
    ...
    handleActived: function handleActived(params, evnt) {
      ...
      if (_tools.UtilTools.isEnableConf(editRender) && cell) {
    ...
    handleFocus: function handleFocus(params) {
      ...
      if (_tools.UtilTools.isEnableConf(editRender)) {
    ...
    _setActiveRow: function _setActiveRow(row) {
      return this.setActiveCell(row, _ctor.default.find(this.visibleColumn, function (column) {
        return _tools.UtilTools.isEnableConf(column.editRender);
      }));
    },
    ...
    _setActiveCell: function _setActiveCell(row, fieldOrColumn) {
      ...
      if (row && column && _tools.UtilTools.isEnableConf(column.editRender)) {
