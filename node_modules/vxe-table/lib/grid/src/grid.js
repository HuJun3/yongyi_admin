...
var _default2 = {
  ...
  computed: {
    ...
    tableProps: function tableProps() {
      ...
      if (proxyConfig) {
        ...
        if ((proxyOpts.seq || proxyOpts.index) && _tools.UtilTools.isEnableConf(pagerConfig)) {
  ...
  created: function created() {
    ...
    this.$nextTick(function () {
      ...
      if (xTable && xTable.isSC) {
        _tools.UtilTools.error('vxe.error.errProp', ['<vxe-table-column ...>', 'columns']);
      }
    });
  ...
  render: function render(h) {
    ...
    var $scopedSlots = this.$scopedSlots,
        vSize = this.vSize,
        isZMax = this.isZMax;
    var hasForm = !!($scopedSlots.form || _tools.UtilTools.isEnableConf(this.formConfig));
    var hasToolbar = !!($scopedSlots.toolbar || _tools.UtilTools.isEnableConf(this.toolbarConfig) || this.toolbar);
    var hasTop = !!$scopedSlots.top;
    var hasBottom = !!$scopedSlots.bottom;
    var hasPager = !!($scopedSlots.pager || _tools.UtilTools.isEnableConf(this.pagerConfig));
    return h('div', {
  ...
  methods: _objectSpread(_objectSpread({}, methods), {}, {
    ...
    initProxy: function initProxy() {
      ...
      if (proxyConfig) {
        if (_tools.UtilTools.isEnableConf(formConfig) && proxyOpts.form && formOpts.items) {
          var formData = {};
        ...
        case 'query':
          {
            ...
            if (ajaxMethods) {
              ...
              if (pagerConfig) {
                ...
                if (_tools.UtilTools.isEnableConf(pagerConfig)) {
    ...
    getFormItems: function getFormItems(index) {
      ...
      var items = _tools.UtilTools.isEnableConf(formConfig) && formConfig.items ? formConfig.items : [];
