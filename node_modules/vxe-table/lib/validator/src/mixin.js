          ...
          rules.forEach(function (rule) {
            if (type === 'all' || !rule.trigger || type === rule.trigger) {
              if (_ctor.default.isFunction(rule.validator)) {
                ...
                var numVal = isNumType ? _ctor.default.toNumber(cellValue) : _ctor.default.getSize(cellValue);

                if (rule.required && (isArrType ? !_ctor.default.isArray(cellValue) || !cellValue.length : cellValue === null || cellValue === undefined || cellValue === '')) {
                  _this3.validRuleErr = true;
