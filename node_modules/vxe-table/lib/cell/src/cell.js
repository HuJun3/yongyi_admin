...
var Cell = {
  ...
  renderEditHeader: function renderEditHeader(h, params) {
    ...
    }) : null, _tools.UtilTools.isEnableConf(editRender) && editOpts.showIcon ? h('i', {
  ...
  renderRowEdit: function renderRowEdit(h, params) {
    ...
    return Cell.runRenderer(h, params, this, _tools.UtilTools.isEnableConf(editRender) && actived && actived.row === params.row);
  },
  ...
  renderCellEdit: function renderCellEdit(h, params) {
    ...
    var editRender = column.editRender;
    var actived = $table.editStore.actived;
    return Cell.runRenderer(h, params, this, _tools.UtilTools.isEnableConf(editRender) && actived && actived.row === params.row && actived.column === params.column);
  },
