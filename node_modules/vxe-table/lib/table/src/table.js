...
var _default2 = {
  ...
  computed: {
    ...
    isCtxMenu: function isCtxMenu() {
      return (this.contextMenu || this.menuConfig) && _tools.UtilTools.isEnableConf(this.ctxMenuOpts) && (this.headerCtxMenu.length || this.bodyCtxMenu.length || this.footerCtxMenu.length);
    },
    ctxMenuOpts: function ctxMenuOpts() {
      return Object.assign({}, _conf.default.table.contextMenu, _conf.default.table.menuConfig, this.contextMenu, this.menuConfig);
    },
  ...
  created: function created() {
    ...
    if (mouseOpts.checked && mouseOpts.area) {
      _tools.UtilTools.error('vxe.error.errConflicts', ['mouse-config.checked', 'mouse-config.area']);
    } // v3 中只支持对象类型
    ...
    if (this.optimization) {
      _tools.UtilTools.warn('vxe.error.removeProp', ['optimization']);
    } // 废弃 optimization.cloak


    if (this.optimizeOpts.cloak) {
      _tools.UtilTools.warn('vxe.error.delProp', ['optimization.cloak', 'cloak']);
    } // 废弃 optimization.animat


    if (this.optimizeOpts.animat) {
      _tools.UtilTools.warn('vxe.error.delProp', ['optimization.animat', 'animat']);
    } // 废弃 optimization.delayHover


    if (this.optimizeOpts.delayHover) {
      _tools.UtilTools.warn('vxe.error.delProp', ['optimization.delayHover', 'delay-hover']);
    } // 废弃 optimization.scrollX


    if (this.optimizeOpts.scrollX) {
      _tools.UtilTools.warn('vxe.error.delProp', ['optimization.scrollX', 'scroll-x']);
    } // 废弃 optimization.scrollY


    if (this.optimizeOpts.scrollY) {
      _tools.UtilTools.warn('vxe.error.delProp', ['optimization.scrollY', 'scroll-y']);
    }
