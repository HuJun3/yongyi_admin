...
$vxe-table-header-column-checked-border-color: #cccfd6;
$vxe-table-body-seq-column-checked-border-color: $vxe-table-header-column-checked-border-color;
$vxe-table-body-column-checked-border-color: #D4D4D4;
$vxe-table-column-header-checked-background-color: #DCDCDC;
$vxe-table-column-body-seq-checked-background-color: $vxe-table-column-header-checked-background-color;
...
$vxe-tooltip-validate-error-color: #fff;
$vxe-tooltip-validate-error-background-color: #f56c6c;
